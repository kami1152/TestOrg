...
<!--     
    <form id="listForm2" action="user.do" method="get">
    	<input type="hidden" id="action" name="action" value="view">
    	<input type="hidden" id="userid" name="userid" >
    </form>
    <form id="listForm3" action="user.do?action=view" method="get">
    	<input type="hidden" id="userid" name="userid" >
    </form>
    <form id="listForm3" action="user.do?action=view" method="post">
    	<input type="hidden" id="userid" name="userid" >
    </form>
 -->    
    <table border="1">
